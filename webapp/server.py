...
def _voice_prompt_context(user, messages: list[dict]) -> dict:
    ...
    return {
        ...
        "lesson_loop": (
            "Сначала живо отреагируй на смысл реплики ребенка. Затем, только если уместно, дай маленькую "
            "английскую фразу вроде I want..., I like..., Can I have...? Не требуй повторения каждый раз; "
            "иногда задай естественный вопрос или продолжи сцену. Через несколько реплик верни одно старое слово."
        ),
        "conversation_plan": (
