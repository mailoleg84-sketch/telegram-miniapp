...
def _word_dict(word, learner_level: str = "beginner") -> dict:
    ...
    return {
        ...
        "meaning_badge": visual.get("meaning_badge", ""),
        "explanation_ru": visual.get("explanation_ru", ""),
        "card_example": visual.get("card_example", ""),
        "card_example_ru": visual.get("card_example_ru", ""),
        "phrases": visual.get("phrases", []),
