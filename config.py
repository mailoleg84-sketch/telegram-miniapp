...
APP_VERSION = _env("APP_VERSION", "20260624-kids-v156")
...
# Бесплатные child-safe фото для слов (Pixabay, safesearch). По умолчанию ВКЛ. Фото
# отдаётся только для КОНКРЕТНЫХ существительных (visual_type == "object": apple,
# house, table…) — см. allows_free_photo; абстрактные существительные (lesson/answer),
# действия и служебные слова остаются на учебной SVG-сцене, сенситивные — всегда SVG.
